      ...
      <div className="grid gap-8 lg:grid-cols-[1.2fr_0.8fr]">
        <section className="card">
          ...
          <form className="mt-6 space-y-4" onSubmit={handleSubmit}>
            ...
            <button className="button w-full disabled:cursor-not-allowed disabled:opacity-60" type="submit" disabled={isSubmitting}>
          ...
          <div>
            ...
            <ul className="mt-2 space-y-2 text-sm">
              <li>
                ...
                <p className="mt-1 font-medium">manager@slooze.xyz / pass1234</p>
              </li>
              <li>
                <span className="badge">Store Keeper</span>
                <p className="mt-1 font-medium">keeper@slooze.xyz / pass1234</p>
              </li>
            </ul>
          </div>
